...
export default function ChatClient({ clientId, coachId, lang }: { clientId: string; coachId: string; lang: Lang }) {
  ...
  return (
    <Card className="h-[600px] flex flex-col animate-fade-in mb-20">
      <CardContent className="flex-1 flex flex-col p-0 overflow-hidden">
        ...
        {/* Message Input */}
        <form onSubmit={handleSend} className="p-4 border-t border-slate-800 bg-slate-900 z-10">
          <div className="flex gap-2">
            <input
              ...
              autoFocus={false}
            />
            <Button type="submit" disabled={loading || !newMessage.trim()} variant="secondary" className="shrink-0">
